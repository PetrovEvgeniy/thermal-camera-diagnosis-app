...
module.exports = {
    ...
    // https://github.com/node-red/nrlint
    // Add a `nrlint` entry pointing to your nrlint config file (created by snapcraft.yaml)
    //nrlint: require(`${process.env.SNAP}/lib/.nrlintrc.js`),
    ...
    editorTheme: {
        page: {
            title: 'ctrlX Automation',
            // css: '',
            // favicon: '',
            // scripts: ['/absolute/path/to/custom/script/file', '/another/script/file'],
        },
        header: {
            title: 'Node-RED for ctrlX Automation',
            // image: '',
            // url: '',
        },
        /* deployButton: {
